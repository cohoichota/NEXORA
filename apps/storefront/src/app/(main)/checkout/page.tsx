        ...
        <div className="lg:col-span-7">
          <form id="checkout-form" onSubmit={handleCheckout} className="space-y-8">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
              ...
              {!user ? (
                <div className="p-4 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-300 rounded-xl mb-4">
                  <p>You must be signed in to checkout. <Link href="/login" className="font-bold underline">Sign in here</Link></p>
                </div>
              ) : (
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Email address</label>
                    <input type="email" readOnly value={user.email} className="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 opacity-50 cursor-not-allowed" />
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input type="text" name="address" required className="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-indigo-500 outline-none" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">City</label>
                  <input type="text" name="city" required className="w-full px-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-indigo-500 outline-none" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800">
              ...
              <p className="text-sm text-slate-500 mb-6">Payment processing is handled automatically via Saga choreography in the backend.</p>
              <div className="p-4 border border-indigo-200 bg-indigo-50 dark:bg-indigo-900/10 dark:border-indigo-500/30 rounded-xl flex items-center gap-3">
                ...
                <span className="font-medium text-indigo-900 dark:text-indigo-300">Mock Stripe Integration Active</span>
              </div>
            </div>
          </form>
        </div>
