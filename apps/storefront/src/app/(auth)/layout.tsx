    ...
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="hidden md:flex flex-col justify-center items-start p-12 bg-gradient-to-br from-indigo-900 via-slate-900 to-black text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg">
          <Link
            href="/"
            className="text-4xl font-extrabold tracking-tight mb-8 block text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-400"
          >
            Nexora.
          </Link>
          ...
          <p className="text-lg text-indigo-200/80 mb-12">
            Join thousands of businesses and customers building the future of digital commerce on a
          ...
          <div className="flex items-center space-x-4">
            <div className="flex -space-x-3">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="w-10 h-10 rounded-full border-2 border-indigo-900 bg-indigo-500/20 backdrop-blur-md flex items-center justify-center text-xs font-medium"
                >
                  U{i}
                </div>
              ))}
