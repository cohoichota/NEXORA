  ...
  Xe = (e, n, i, t) => {
    if ((n && typeof n == 'object') || typeof n == 'function')
      for (let r of Ge(n))
        !Je.call(e, r) &&
          r !== i &&
          de(e, r, { get: () => n[r], enumerable: !(t = We(n, r)) || t.enumerable });
    return e;
  };
...
h.toDecimalPlaces = h.toDP = function (e, n) {
  ...
  return (
    ...
    e === void 0
      ? i
      : (_(e, 0, $), n === void 0 ? (n = t.rounding) : _(n, 0, 8), p(i, e + i.e + 1, n))
  );
};
...
h.toNearest = function (e, n) {
  ...
  return (
    e.d[0] ? ((w = !1), (i = S(i, e, 0, n, 1).times(e)), (w = !0), p(i)) : ((e.s = i.s), (i = e)),
    i
  );
};
h.toNumber = function () {
...
var S = (function () {
  ...
  return function (t, r, s, o, u, l) {
    ...
    for (
      l ? ((g = 1), (c = t.e - r.e)) : ((l = D), (g = m), (c = b(t.e / g) - b(r.e / g))),
        T = k.length,
        W = R.length,
        M = new ee(ae),
        q = M.d = [],
    ...
    if (
      ...
      if (((I = (I / g + 2) | 0), (a = 0), T == 1)) {
        ...
        for (
          d = (l / (k[0] + 1)) | 0,
            d > 1 && ((k = e(k, d, l)), (R = e(R, d, l)), (T = k.length), (W = R.length)),
            z = T,
            E = R.slice(0, T),
            P = E.length;
          P < T;
...
function p(e, n, i, t) {
  ...
  e: if (n != null) {
    ...
    if (
      ((t = t || n < 0 || a[d + 1] !== void 0 || (o < 0 ? c : c % C(10, r - o - 1))),
      (f =
        i < 4
          ? (l || t) && (i == 0 || i == (e.s < 0 ? 3 : 2))
          : l > 5 ||
            (l == 5 &&
              (i == 4 ||
                t ||
                (i == 6 && ((s > 0 ? (o > 0 ? c / C(10, r - o) : 0) : a[d - 1]) % 10) & 1) ||
                i == (e.s < 0 ? 8 : 7)))),
      n < 1 || !a[0])
    )
      return (
  ...
  return (
    w && (e.e > g.maxE ? ((e.d = null), (e.e = NaN)) : e.e < g.minE && ((e.e = 0), (e.d = [0]))),
    e
  );
}
function F(e, n, i) {
